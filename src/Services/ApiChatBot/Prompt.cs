...
public static class PromptChat
{
    ...
    @"`You my personal chatbot, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.
====
